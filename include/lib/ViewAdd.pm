...
print MYFILE "echo '<form action=\"'.\$this->url->get().'${modul_name}/addsave\" method=\"post\">';\n";
print MYFILE "\n";
...
foreach my $param (@param_list2)
{
	...
	print MYFILE "echo '<input name=\"${param}\" type=\"text\" size=\"50\" value=\"'.\$data_${modul_name}['${param}'].'\" placeholder=\"${paramspacelast}\" /> ';\n";
	print MYFILE "echo '<div class=\"LabelSpace\"></div>';\n";
	print MYFILE "\n";
}

print MYFILE "echo '<br>';\n";
print MYFILE "echo '<input type=\"submit\" name=\"submit\" value=\"Add\">';\n";
print MYFILE "echo '&nbsp;&nbsp;';\n";
